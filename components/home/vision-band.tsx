    ...
    <section className="relative isolate overflow-hidden">
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-24 lg:grid-cols-12 lg:px-10 lg:py-32">
        <div className="reveal lg:col-span-7">
          ...
          <blockquote className="reveal-words mt-6 font-heading text-2xl font-medium leading-snug text-primary-foreground sm:text-3xl lg:text-[2.4rem] lg:leading-[1.2]">
            &ldquo;{t('title')}&rdquo;
          </blockquote>
          <p className="reveal mt-8 max-w-xl text-base leading-relaxed text-primary-foreground/70">
            {t('body')}
          </p>
          <Link
            href="/about"
