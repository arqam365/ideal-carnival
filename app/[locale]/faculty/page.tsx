        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <div className="space-y-px overflow-hidden border border-border">
            {members.map((member, i) => (
              <article key={member.name} className="reveal grid gap-8 bg-card p-6 sm:p-8 lg:grid-cols-12 lg:gap-12 lg:p-10" style={{ transitionDelay: `${i * 30}ms` }}>
                <div className="lg:col-span-4">
                  <div className="relative mb-6 aspect-[3/4] overflow-hidden bg-accent">
